...
ActiveRecord::Schema[8.0].define(version: 2025_10_14_063939) do
  ...
  create_table "invitations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id", "email_address"], name: "index_invitations_on_company_id_and_email_address", unique: true
